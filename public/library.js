...
window.LIBRARY = (function(){
  ...
  const IDEAS=[
    ...
    { term:'Coordinate', tags:'x y position lane grid absolute',
      what:'Where something is, as numbers. x is how far across and y is how far up. Setting x puts you there outright; changing x moves you from where you already were.',
      eg:'set x to 2      (absolute)\nchange x by 1   (relative)' },
